...
class BMN(nn.Module):
    ...
    def forward(self, x):
        ...
        confidence_map1 = self.x_2d_p(confidence_map)
        confidence_map2 = self.x_2d_p(confidence_map)
        
        confidence_map3 = confidence_map1 + confidence_map2
        confidence_map3 = self.x_2d_one(confidence_map3)

        confidence_map11 = self.x_2d_one(confidence_map1)
        confidence_map22 = self.x_2d_one(confidence_map2)

        confidence_map = (confidence_map11 + confidence_map22 + confidence_map3) / 3.0
